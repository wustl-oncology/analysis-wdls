...
workflow concordance {
  ...
  output {
    File somalier_pairs = concordance_internal.somalier_pairs
    File somalier_samples = concordance_internal.somalier_samples
  }
}

task concordance_internal {
  input {
    File vcf
    File reference
    File reference_fai
